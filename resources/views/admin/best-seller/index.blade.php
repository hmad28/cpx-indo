        ...
        <div class="md:max-w-7xl 2xl:max-w-full mx-auto sm:px-6 lg:px-8 2xl:px-15">
            <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="text-gray-900 p-5">
                    <div class="p-6">
                        <h1 class="text-2xl font-bold mb-4">Kelola Best Seller</h1>
                        ...
                        <h2 class="text-xl font-semibold mb-3">Daftar Produk Best Seller</h2>
                            ...
                            <table class="w-full border text-sm sm:text-base">
                                <thead>
                                    <tr class="bg-gray-200 text-gray-700">
                                        ...
                                        <th class="p-2 border whitespace-nowrap">Harga</th>
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center p-3">Belum ada produk Best Seller</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
