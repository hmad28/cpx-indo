...
<x-app-layout>
        ...
        <div class="md:max-w-7xl 2xl:max-w-full mx-auto sm:px-6 lg:px-8 2xl:px-15">
            <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="text-gray-900 p-5">
                    <div class="p-6">
                        <h1 class="text-2xl font-bold mb-4">Kelola Nomor WhatsApp</h1>
                            ...
                            <table class="w-full border text-sm sm:text-base">
                                <thead>
                                    <tr class="bg-gray-200 text-gray-700">
                                        <th class="p-2 border whitespace-nowrap">Halaman</th>
                                        <th class="p-2 border whitespace-nowrap">Bagian</th>
                                        <th class="p-2 border whitespace-nowrap">Nomor WA</th>
                                        <th class="p-2 border whitespace-nowrap">Nama Tampilan</th>
                                        <th class="p-2 border whitespace-nowrap">Pesan Default</th>
                                        <th class="p-2 border whitespace-nowrap">Status</th>
                                        <th class="p-2 border whitespace-nowrap">Link WA</th>
                                ...
                                <tbody>
                                    ...
                                    @forelse($whatsappNumbers as $wa)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="p-2 border font-mono">{{ $wa->phone_number }}</td>
                                            <td class="p-2 border">{{ $wa->display_name }}</td>
                                            ...
                                            <td class="p-2 border">
                                                <div class="flex gap-1">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        class="flex items-center py-1.5 px-3 bg-blue-500 hover:bg-blue-400 text-white rounded text-sm">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center p-3">Belum ada nomor WhatsApp</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                            ...
                            @forelse($whatsappNumbers as $wa)
                                <div class="border rounded-lg p-4 shadow flex flex-col gap-2">
                                    ...
                                    <div class="flex gap-2 mt-2">
                                        <button type="button"
                                            onclick="openEditModal({{ $wa->id }}, '{{ $wa->page_name }}', '{{ $wa->phone_number }}', '{{ $wa->display_name }}', '{{ $wa->message }}', {{ $wa->is_active ? 'true' : 'false' }})"
                                            class="flex-1 py-2 bg-blue-500 hover:bg-blue-400 text-white rounded-lg text-sm">
                                            Edit
                                        </button>
    ...
    <div id="editModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-1/2 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Edit Nomor WhatsApp</h3>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <textarea id="edit_message" name="message" rows="3" 
                                class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-green-500" placeholder="Ketik pesan otomatis yang diinginkan"></textarea>
                        </div>
                        <div>
